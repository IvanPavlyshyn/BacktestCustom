...
from backtestingcustom._stats import compute_drawdown_duration_peaks
from backtestingcustom.lib import (
    OHLCV_AGG,
    barssince,
    compute_stats,
    cross,
...
from backtestingcustom.test import GOOG, EURUSD, SMA
from backtestingcustom._util import _Indicator, _as_str, _Array, try_
...
class TestPlot(TestCase):
    ...
    def test_resample(self):
        bt = Backtest(GOOG, SmaCross)
        bt.run()
        import backtestingcustom._plotting
        with _tempfile() as f,\
                patch.object(backtestingcustom._plotting, '_MAX_CANDLES', 10),\
