...
module directly, e.g.
    ...
    from backtestingcustom import Backtest, Strategy
"""
...
class Strategy(metaclass=ABCMeta):
    ...
    override methods
    `backtestingcustom.backtestingcustom.Strategy.init` and
    `backtestingcustom.backtestingcustom.Strategy.next` to define
    your own strategy.
    """
    def __init__(self, broker, data,  params, from_date=None, main_signal=None):
    ...
    def I(self,  # noqa: E743
        ...
        `backtestingcustom.backtestingcustom.Strategy.next` much like
        `backtestingcustom.backtestingcustom.Strategy.data` is.
        Returns `np.ndarray` of indicator values.

        `func` is a function that returns the indicator array(s) of
        same length as `backtestingcustom.backtestingcustom.Strategy.data`.

        In the plot legend, the indicator is labeled with
        function name, unless `name` overrides it.

        If `plot` is `True`, the indicator is plotted on the resulting
        `backtestingcustom.backtestingcustom.Backtest.plot`.
    ...
    def init(self):
        ...
        Declare indicators (with `backtestingcustom.backtestingcustom.Strategy.I`).
        Precompute what needs to be precomputed or can be precomputed
        in a vectorized fashion before the strategy starts.

        If you extend composable strategies from `backtestingcustom.lib`,
        make sure to call:
    ...
    def next(self):
        ...
        `backtestingcustom.backtestingcustom.Strategy.data`
        instance (row; full candlestick bar) becomes available.
        This is the main method where strategy decisions
        upon data precomputed in `backtestingcustom.backtestingcustom.Strategy.init`
        take place.
    ...
    def data(self) -> _Data:
        ...
        `backtestingcustom.backtestingcustom.Backtest.__init__`,
        ...
        * Within `backtestingcustom.backtestingcustom.Strategy.init`, `data` arrays
          are available in full length, as passed into
          `backtestingcustom.backtestingcustom.Backtest.__init__`
          (for precomputing indicators and such). However, within
          `backtestingcustom.backtestingcustom.Strategy.next`, `data` arrays are
          only as long as the current iteration, simulating gradual
          price point revelation. In each call of
          `backtestingcustom.backtestingcustom.Strategy.next` (iteratively called by
          `backtestingcustom.backtestingcustom.Backtest` internally),
    ...
    def position(self) -> 'Position':
        """Instance of `backtestingcustom.backtestingcustom.Position`."""
...
class Position:
    ...
    `backtestingcustom.backtestingcustom.Strategy.position` within
    `backtestingcustom.backtestingcustom.Strategy.next`.
...
class Backtest:
    ...
    `backtestingcustom.backtestingcustom.Backtest.run` to run a backtest
    instance, or `backtestingcustom.backtestingcustom.Backtest.optimize` to
    optimize it.
    """
    ...
    def __init__(self,
        ...
        `strategy` is a `backtestingcustom.backtestingcustom.Strategy`
    ...
    def run(self,  **kwargs) -> pd.Series:
        ...
        strategy: Strategy = self._strategy(broker, data,kwargs, from_date=self._from_date, main_signal=self._main_signal  )

        strategy.init(from_date=self._from_date, main_signal=self._main_signal )
    ...
    def optimize(self, *,
        ...
        `backtestingcustom.backtestingcustom.Backtest.run`-returned results series,
        ...
        * `"skopt"` which finds close-to-optimal strategy parameters using
        ...
        (see `backtestingcustom.lib.plot_heatmaps()`).
    ...
    def plot(self, *, results: pd.Series = None, filename=None, plot_width=None,
        ...
        `backtestingcustom.backtestingcustom.Backtest.run` or
        `backtestingcustom.backtestingcustom.Backtest.optimize`, otherwise the last
        ...
        [TRADES_AGG]: lib.html#backtestingcustom.lib.TRADES_AGG
        ...
        return plot(
            ...
            filename=f'/Users/Ivan/Documents/Projects/Crypto/Everstake/EMA_backtest/plots_htmls/{results._strategy}.html',
